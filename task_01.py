...
class Homework(Trie):
    ...
    def count_words_with_suffix(self, pattern: str) -> int:
        ...
        Args:
            pattern (str): Суфікс, за яким виконується пошук.

        Returns:
            int: Кількість слів, що закінчуються на цей суфікс.
        """
    ...
    def has_prefix(self, prefix: str) -> bool:
        ...
        Args:
            prefix (str): Префікс, що перевіряється.

        Returns:
            bool: True, якщо хоча б одне слово починається з цього префікса, інакше False.
        """
